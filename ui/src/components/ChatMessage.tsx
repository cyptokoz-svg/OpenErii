...
function EriiAvatar() {
  return (
    <div className="w-6 h-6 rounded-full flex items-center justify-center shrink-0" style={{ background: 'linear-gradient(135deg, rgba(244,114,182,0.15) 0%, rgba(192,132,252,0.15) 100%)' }}>
      <svg width="12" height="12" viewBox="0 0 24 24" fill="url(#avatarGrad)" stroke="none">
        <defs>
      ...
      <div className="flex items-start gap-3 message-enter ml-8">
        ...
        <div className="flex-1 min-w-0 py-0.5">
          <div className="flex items-center gap-1.5 mb-1">
            ...
            <span className="text-[11px] text-text-muted/60 font-medium">{t('chat.notification')}</span>
          </div>
  ...
  if (role === 'user') {
    return (
      <div className="flex flex-col items-end message-enter group">
        <div className="max-w-[75%] px-4 py-3 rounded-2xl rounded-br-sm break-words glow-purple user-bubble">
    ...
    <div className="flex flex-col items-start message-enter group">
      {!isGrouped && (
        <div className="flex items-center gap-2 mb-1.5">
          <EriiAvatar />
          <span className="text-[12px] text-text-muted font-medium">Erii</span>
        </div>
      )}
